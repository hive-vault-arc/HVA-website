...
export default function BlogIndex() {
  ...
  return (
    <main className="bg-[#f7f9fb] min-h-screen">
      {/* Hero */}
      <section className="bg-[#0F172A] pt-36 pb-20 px-6 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-8">
            ...
            <h1
              className="text-5xl md:text-7xl font-light leading-tight tracking-tight text-white"
          ...
          <div className="lg:col-span-4 pb-2">
            <p
              className="text-lg leading-relaxed pl-6 text-white/60"
              style={{
            ...
            <Link href={`/blog/${featured.slug}`} className="group block">
              <div className="grid grid-cols-1 lg:grid-cols-12 items-center overflow-hidden">
                ...
                <div className="lg:col-span-7 relative">
                  <div className="aspect-[4/3] w-full overflow-hidden bg-[#e0e3e5]">
                    <Image
                ...
                <div className="lg:col-span-6 lg:-ml-24 z-10 mt-0">
                  <div
