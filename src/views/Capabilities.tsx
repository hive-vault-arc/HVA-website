...
export default function Capabilities() {
  ...
  return (
    <div className="relative isolate overflow-x-hidden bg-[#f7f9fb] text-[#191c1e]">
      ...
      <section id="capability-pillars" className="scroll-mt-28 px-6 lg:px-12 pb-24">
        <div className="mx-auto max-w-screen-2xl">
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                <div className="mb-8 flex h-12 w-12 items-center justify-center bg-white/78 text-[#2563EB] ring-1 ring-[#0F172A]/10">
              ...
              <ul className="relative z-10 mt-8 space-y-2">
                {pillar0?.bullets.map((b) => (
                  <li key={b} className="text-[0.68rem] font-bold tracking-[0.14em] text-[#475569]/75 uppercase">
                    {b}
                  </li>
                ))}
              </ul>
            ...
            >
              ...
              />
              <div className="relative z-10 p-10 flex flex-col justify-between min-h-[420px] bg-gradient-to-t from-[#081628]/95 via-[#0F172A]/58 to-[#2563EB]/12">
                <div>
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#081628]/95 via-[#0F172A]/64 to-[#2563EB]/14" />
              <div className="relative z-10">
                <div className="mb-8 flex h-12 w-12 items-center justify-center bg-white/10 text-white">
                ...
                <div className="relative z-10 mt-8 flex flex-col gap-2">
                  {pillar2?.landingLinks.map((lnk) => (
                    <Link
                      key={lnk.href}
                      href={lnk.href}
                      className="inline-flex items-center gap-1.5 text-[0.7rem] font-bold uppercase tracking-[0.14em] text-[#93c5fd] hover:text-white transition-colors group/link"
                    >
                      {lnk.label}
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-[#334155] leading-relaxed text-sm">{pillar3?.summary}</p>
              </div>
              <div className="relative z-10 mt-8 space-y-2">
                <div className="w-full h-px bg-[#0F172A]/15" />
                <p className="text-[0.62rem] font-bold text-[#475569]/75 uppercase tracking-[0.16em] py-2">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-[#334155] leading-relaxed text-sm">{pillar4?.summary}</p>
              </div>
              <div className="relative z-10 flex flex-wrap gap-2 mt-8">
                {['AWS', 'Azure', 'GCP', 'Hybrid'].map((tag) => (
                  <span
                    key={tag}
                    className="border border-[#0F172A]/15 bg-white/70 px-3 py-1 text-[0.6rem] font-bold text-[#334155] uppercase tracking-[0.12em]"
                  >
                    {tag}
                  </span>
                ))}
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#081628]/95 via-[#0F172A]/76 to-[#2563EB]/20" />
            <div
              aria-hidden="true"
            ...
            <Link
              href="/contact"
              className="relative z-10 inline-flex items-center gap-1.5 sharp-edge whitespace-nowrap px-8 py-3.5 bg-[#2563EB] text-white text-[0.78rem] font-bold uppercase tracking-[0.14em] hover:bg-[#1d4ed8] transition-colors"
            >
              Delegate Operations →
            </Link>
          </motion.div>
          ...
          >
            ...
            >
              <div className="w-full">
                ...
                <div className="grid grid-cols-1 gap-px bg-[#cbd5e1] sm:grid-cols-3">
                  {['Decision gates', 'Joint governance', 'Managed continuity'].map((item, index) => (
                    <div key={item} className="bg-white px-4 py-3">
                      <p className="text-[0.62rem] font-bold uppercase tracking-[0.14em] text-[#2563EB]">
                        0{index + 1}
                      </p>
                      <p className="mt-1 text-xs font-semibold text-[#334155]">{item}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          >
            <div className="flex flex-col gap-3 lg:min-h-0">
              <div className="border border-[#cbd5e1] bg-white p-4">
                ...
                <div className="relative h-2 bg-[#e2e8f0]">
                  <motion.div
                ...
                <div className="mt-4 grid grid-cols-3 gap-px bg-[#cbd5e1]">
                    ...
                    <div className="relative min-h-32 border-t border-[#d9dee7] sm:min-h-0 sm:border-l sm:border-t-0">
                      ...
                      <div
                        className={`absolute inset-0 transition-colors duration-150 ${
                          isActive ? 'bg-[#2563EB]/10' : 'bg-[#0F172A]/18 group-hover:bg-[#0F172A]/8'
                        }`}
                      />
                    </div>
                  </button>
            ...
            >
              <div className="grid h-full gap-4">
                <div className="relative min-h-[220px] overflow-hidden border border-white/[0.08] bg-white/[0.04]">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#0F172A]/92 via-[#0F172A]/46 to-[#0F172A]/8" />
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0F172A] to-transparent p-4 md:p-5">
                    <div className="flex flex-wrap items-end justify-between gap-4">
                      <div>
                        <p className="text-[0.62rem] font-bold uppercase tracking-[0.18em] text-[#93c5fd]">
                ...
                <div className="grid gap-px border border-white/[0.08] bg-white/[0.08] md:grid-cols-[1fr_220px]">
                  <div className="bg-[#0F172A] p-4">
                    <div className="mb-3 flex items-center gap-3">
                      ...
                      <div className="text-[#60a5fa] shrink-0">{activeBOTItem.icon}</div>
                    </div>
                  ...
                  <div className="grid grid-cols-3 bg-white/[0.03] md:grid-cols-1">
                    {BOT_PHASES.map((item, index) => (
                      <button
                        ...
                        onFocus={() => setActiveBOTStep(index)}
                        aria-pressed={activeBOTStep === index}
                        className={`flex items-center justify-between border-r border-white/[0.08] px-3 py-3 text-left text-[0.65rem] font-bold uppercase tracking-[0.12em] last:border-r-0 md:border-b md:border-r-0 md:last:border-b-0 transition-colors duration-150 ${
                          activeBOTStep === index
                ...
                <div className="grid grid-cols-1 gap-px border border-white/[0.08] bg-white/[0.08] md:grid-cols-3">
                  {activeBOTSnapshot.map((section) => (
                    <article key={section.label} className="bg-[#0F172A] p-4">
                      <p className="mb-3 text-[0.62rem] font-bold uppercase tracking-[0.18em] text-[#60a5fa]">
                        {section.label}
                      </p>
                ...
                <div className="border border-white/[0.08] bg-[#0b1223]">
                  ...
                  <div className="grid grid-cols-1 gap-px bg-white/[0.08] md:grid-cols-3">
                    {activeBOTExecutionDetail.map((section) => (
                      <article key={section.label} className="bg-[#0F172A] p-4">
                        <p className="mb-3 text-[0.62rem] font-bold uppercase tracking-[0.16em] text-[#60a5fa]">
                          {section.label}
                        </p>
                        <ul className="space-y-2">
                          {section.items.map((item) => (
                            <li key={`${section.label}-${item}`} className="flex items-start gap-2 text-xs leading-relaxed text-[#aeb8c8]">
      ...
      {/* ── SOLUTION PROGRAMS ─────────────────────────────────────────────── */}
      <section id="solution-programs" className="scroll-mt-28 bg-[#f7f9fb] px-6 py-20 lg:px-12">
        <div className="mx-auto max-w-screen-2xl">
          <motion.div
            initial="hidden"
            whileInView="show"
          ...
          >
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }} className="mb-10 border-t border-[#cbd5e1] pt-8">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-12 md:items-end">
                <div className="md:col-span-7">
                  <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.24em] text-[#2563EB]">
                    Solution Programs
                  </p>
                  <h2 className="font-headline text-4xl leading-[1.06] text-[#0F172A] md:text-5xl">
                    Pre-scoped.
                    <br />
                ...
                <div className="md:col-span-5">
                  <p className="max-w-md text-sm leading-relaxed text-[#45464d]">
                  ...
                  <div className="mt-5 grid grid-cols-3 gap-px bg-[#cbd5e1]">
                    {['Scoped', 'Built', 'Operated'].map((item, index) => (
                      <div key={item} className="bg-white px-3 py-2.5">
                        <p className="text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#2563EB]">
                          0{index + 1}
                        </p>
                        <p className="mt-1 text-xs font-semibold text-[#334155]">{item}</p>
                      </div>
            ...
            <div className="grid grid-cols-1 gap-px border border-[#d7dde7] bg-[#d7dde7] md:grid-cols-3">
              {CAPABILITY_SOLUTION_PROGRAM_DETAILS.map((program, i) => {
                ...
                return (
                  <motion.article
                    ...
                    variants={fadeUp}
                    transition={{ duration: 0.5 }}
                    className="group flex min-h-[520px] flex-col bg-white transition-colors duration-200 hover:bg-[#f8fafc]"
                  >
                    <div className="relative h-40 overflow-hidden bg-[#0F172A]">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0F172A]/88 via-[#0F172A]/36 to-transparent" />
                    ...
                    <div className="flex flex-1 flex-col p-7">
                      <p className="mb-2 text-[0.6rem] font-bold uppercase tracking-[0.18em] text-[#2563EB]">
                        {program.category}
                      </p>
                      <h3 className="mb-3 font-headline text-xl leading-tight text-[#0F172A] transition-colors duration-200 group-hover:text-[#2563EB]">
                        {program.name}
                      </h3>
                      <p className="mb-5 flex-1 text-sm leading-relaxed text-[#45464d]">
                        {program.summary}
                      </p>

                      <div className="mb-5 grid grid-cols-1 gap-px bg-[#d9dee7]">
                        <div className="bg-[#f8fafc] p-3">
                          <p className="mb-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#64748b]">
                            Build Scope
                          </p>
                      ...
                      <div className="mb-5 flex flex-wrap gap-1.5">
                        {program.integrations.slice(0, 3).map((integration) => (
                          <span
                            key={integration}
                            className="border border-[#d9dee7] bg-white px-2 py-1 text-[0.58rem] font-bold uppercase tracking-[0.1em] text-[#475569]"
                          >
                            {integration}
                          </span>
                        ))}
                      ...
                      {program.proofLinks.length > 0 && (
                        <Link
                          ...
                          className="mt-auto inline-flex text-[0.68rem] font-bold uppercase tracking-[0.14em] text-[#2563EB] transition-colors hover:text-[#1d4ed8]"
                        >
                          View Case Study →
                        </Link>
                      )}
