...
export default function Arc() {
  ...
  return (
    <div className="relative isolate overflow-x-clip bg-[#f7f9fb] text-[#0F172A]">
      <motion.div
        aria-hidden="true"
        className="fixed left-0 right-0 top-0 z-[70] h-[3px] origin-left bg-[#2563EB]"
        style={{ scaleX: progressScale }}
      />

      <section className="relative overflow-hidden bg-[#f7f9fb] px-6 pb-16 pt-36 text-white lg:px-12 lg:pb-20">
        <div aria-hidden="true" className="absolute inset-x-0 bottom-0 top-28 bg-[#0F172A]" />
        <div
          aria-hidden="true"
        ...
        <div className="relative z-10 mx-auto grid max-w-screen-2xl grid-cols-1 gap-10 lg:grid-cols-12 lg:items-end">
          ...
          >
            <span className="mb-6 block text-[10px] font-bold uppercase tracking-[0.28em] text-[#60a5fa]">
              ARC Framework
            </span>
            <h1 className="max-w-4xl font-headline text-[clamp(3.4rem,8vw,7.4rem)] font-light leading-[0.92] tracking-tight">
              Assess.
              <br />
              Re-engineer.
              <br />
              <em className="font-headline italic text-[#60a5fa]">Command.</em>
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-relaxed text-white/70">
              H.V.A's operating model for transformation work: strategy, AI engineering, software delivery, cloud, and managed operations in one continuous accountability loop.
            </p>
            <div className="mt-9 flex flex-wrap items-center gap-4">
              <Link href="/contact" className="sharp-edge bg-[#2563EB] px-7 py-4 text-sm font-bold uppercase tracking-[0.14em] text-white transition-colors hover:bg-[#1d4ed8]">
                Book Discovery Call
              </Link>
              <Link href="/capabilities" className="inline-flex items-center gap-2 border-b border-white/25 pb-1 text-sm font-bold uppercase tracking-[0.14em] text-white/80 transition-colors hover:border-[#60a5fa] hover:text-white">
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="mx-auto max-w-screen-2xl px-6 lg:px-12">
          <div className="mb-10 grid grid-cols-1 gap-7 border-b border-[#dbe1ea] pb-8 md:grid-cols-12 md:items-end">
            <div className="md:col-span-7">
              <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.28em] text-[#2563EB]">
                Engagement Method
              </p>
              <h2 className="max-w-3xl font-headline text-4xl font-light leading-[1.02] text-[#0F172A] md:text-6xl">
                A transformation model built around decision gates.
              </h2>
            </div>
            <p className="md:col-span-5 text-base leading-relaxed text-[#475569]">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 gap-px bg-[#dbe1ea] lg:grid-cols-3"
          >
            {arcPhases.map((phase, idx) => (
              <motion.article key={phase.step} variants={fadeUp} transition={{ duration: 0.5 }} className="bg-white">
                <div className="relative h-64 overflow-hidden bg-[#0F172A]">
                  ...
                  <span className="absolute left-5 top-5 bg-[#2563EB] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-white">
                    Phase {phase.step}
                  </span>
                ...
                <div className="p-6 md:p-7">
                  <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.2em] text-[#2563EB]">
                    {phase.layer}
                  </p>
                  <p className="min-h-[84px] text-sm leading-relaxed text-[#475569]">{phase.summary}</p>
                  <div className="mt-6 border-t border-[#e2e8f0] pt-5">
                    <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.18em] text-[#94a3b8]">
                      Outputs
                    </p>
                    <ul className="space-y-2">
                      {phase.owns.map((item) => (
                        <li key={item} className="flex items-start gap-2 text-sm text-[#0F172A]">
                          <span className="mt-2 h-1 w-1 shrink-0 bg-[#2563EB]" />
                          {item}
                        </li>
                      ))}
                    </ul>
                  </div>
                  <div className="mt-6 border border-[#dbe1ea] bg-[#f7f9fb] px-4 py-3 text-xs font-bold uppercase tracking-[0.14em] text-[#475569]">
                    {phase.gate}
                  </div>
                </div>
              </motion.article>
      ...
      <section className="relative overflow-hidden bg-[#0F172A] py-16 text-white md:py-20">
        ...
        <div className="relative z-10 mx-auto grid max-w-screen-2xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:px-12">
          <div className="lg:col-span-5">
            <p className="mb-4 text-[10px] font-bold uppercase tracking-[0.28em] text-[#60a5fa]">
          ...
          >
            {differenceContrasts.map((item) => (
              <motion.div key={item.others} variants={fadeUp} transition={{ duration: 0.45 }} className="grid gap-4 bg-[#0F172A] p-6 md:grid-cols-[0.9fr_1.1fr] md:p-7">
        ...
        <div className="mx-auto max-w-screen-2xl px-6 lg:px-12">
          <div className="mb-10 grid grid-cols-1 gap-7 md:grid-cols-12 md:items-end">
            <div className="md:col-span-7">
              ...
              <h2 className="font-headline text-4xl font-light leading-[1.02] text-[#0F172A] md:text-6xl">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {proofCards.map((card, idx) => (
              <motion.article
                ...
                className="group relative h-[360px] overflow-hidden bg-[#0F172A]"
              >
                <Image
                  src={card.image}
                  alt={card.alt}
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="mx-auto grid max-w-screen-2xl grid-cols-1 gap-px bg-[#dbe1ea] px-6 lg:grid-cols-[0.82fr_1.18fr] lg:px-12">
          <div className="bg-[#0F172A] p-8 text-white md:p-10">
            ...
            <p className="mt-5 max-w-lg text-sm leading-relaxed text-white/65">
              H.V.A tracks the technologies that change operating models first, then folds the useful ones into ARC delivery patterns.
            </p>
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.15 }}
            transition={{ staggerChildren: 0.08 }}
            className="grid grid-cols-1 gap-px bg-[#dbe1ea] md:grid-cols-2"
          >
            {innovationTracks.map((track) => (
              <motion.article key={track.code} variants={fadeUp} transition={{ duration: 0.45 }} className="bg-white p-7">
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[10px] text-[#94a3b8]">{track.code}</span>
                </div>
                <h3 className="font-headline text-2xl text-[#0F172A]">{track.title}</h3>
