    ...
    <>
      ...
      <main className="bg-neutral text-tertiary">
        ...
        <section className="mx-auto max-w-5xl space-y-12 px-6 py-14 lg:px-12">
          <article>
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              <div className="geo-card card-hover">
                <h3 className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Core Layer</h3>
                <p className="mt-3 text-sm leading-relaxed text-secondary">
                  Conversation intelligence, intent handling, qualification logic, and channel-aware response rules.
                </p>
              </div>
              <div className="geo-card card-hover">
                <h3 className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Operations Layer</h3>
                <p className="mt-3 text-sm leading-relaxed text-secondary">
          ...
          <article>
            <h2 className="services-brief-section-title">Industries We Support Across Morocco</h2>
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              <div className="geo-card card-hover">
                <h3 className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Real Estate</h3>
                <p className="mt-3 text-sm leading-relaxed text-secondary">
                  Lead qualification, property inquiry handling, and pipeline routing to sales teams by readiness level.
                </p>
              </div>
              <div className="geo-card card-hover">
                <h3 className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Healthcare</h3>
                <p className="mt-3 text-sm leading-relaxed text-secondary">
                  Appointment support, FAQ triage, and patient communication workflows with controlled escalation.
                </p>
              </div>
              <div className="geo-card card-hover">
                <h3 className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Logistics</h3>
                <p className="mt-3 text-sm leading-relaxed text-secondary">
                  Dispatch communication support, status handling, and operator workflow coordination under load.
                </p>
              </div>
              <div className="geo-card card-hover">
                <h3 className="text-sm font-bold uppercase tracking-[0.14em] text-primary">Finance</h3>
                <p className="mt-3 text-sm leading-relaxed text-secondary">
          ...
          <article>
            <h2 className="services-brief-section-title">Typical Pricing Ranges</h2>
            <p className="mt-4 text-base leading-relaxed text-secondary">
