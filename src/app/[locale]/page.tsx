...
> = {
  en: {
    ...
    keywords: [
      ...
      'custom mobile app for my company Morocco',
      'custom web app development Tangier',
      'CRM migration services Morocco',
      'CRM integration with ERP Morocco',
      'workflow automation partner Morocco',
      'cloud migration and deployment Morocco',
      'DevOps and CI/CD consulting Morocco',
      'AI receptionist setup for business Morocco',
      'AI analyst dashboards for company decisions',
      'I need a team to build my app in Morocco',
      'best software agency for startup in Tangier',
    ],
